...
- `dockerfile.interface` — Interface container (lightweight, only needs streamlit/pandas/requests).
...
**Scoring**: starts at 100, penalties for Slither findings, bonuses for age >1 year (+5) and ETH balance >$1M (+10). Clamped to [0, 100].
